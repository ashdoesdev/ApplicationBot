...
class AbortCharterEmbed extends discord_js_1.RichEmbed {
    constructor(leadership) {
        ...
        this.setDescription('Please read our charter before applying. Feel free to send another /apply in the <#593132225302626356> channel when you are ready to begin.');
