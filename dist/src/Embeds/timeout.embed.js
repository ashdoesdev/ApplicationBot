...
class TimeoutEmbed extends discord_js_1.RichEmbed {
    constructor(leadership, applyChannel) {
        ...
        this.setDescription(`Application process aborted due to 30 minutes of inactivity. Feel free to send another /apply in the <#${applyChannel}> channel when you are ready to start again.`);
