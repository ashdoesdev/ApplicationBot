...
export class TimeoutEmbed extends RichEmbed {
    ...
    constructor(leadership: GuildMember[]) {
        ...
        this.setDescription('Application process aborted due to 30 minutes of inactivity. Feel free to send another /apply in the <#593132225302626356> channel when you are ready to start again.')
